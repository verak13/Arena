...
import arena.arena.security.auth.RestAuthenticationEntryPoint;
import arena.arena.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/test/try").permitAll()
